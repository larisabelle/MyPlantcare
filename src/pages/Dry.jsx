    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Typography color={"#FFFFFF"} fontSize="24px" >Suas plantas necessitam de atenção!</Typography>
                <Typography color={"#FFFFFF"} fontSize="24px">Irrigue-as o mais rápido possível.</Typography>
